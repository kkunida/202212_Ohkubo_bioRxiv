function dxdt = deTremblay1992MFStateFcn(x,u)
%% Parameters
mu_max = 1.09/24;       % [/h]
mu_death_max3 = 0.69/(24^3); % [/h^3]
Kdeath_Lac = 0.01/24;   % [/(mM*h)]
Kdeath_Amm = 0.06/24;   % [/(mM*h)]
Kdeath_Gln = 0.02;      % [mM]
Y_X_Glc = 1.09E+8;      % [cell/mmol]
Y_X_Gln = 3.8E+8;       % [cell/mmol]
Y_Lac_Glc = 1.8;        % [mmol/mmol]
Y_Amm_Gln = 0.85;       % [mmol/mmol]
...
dV_Glc = Q_Glc;
dV_Gln = Q_Gln;
dxdt = [dVdt; dXvdt; dXtdt; dMetabdt; dmAbdt; dV_Glc; dV_Gln];
