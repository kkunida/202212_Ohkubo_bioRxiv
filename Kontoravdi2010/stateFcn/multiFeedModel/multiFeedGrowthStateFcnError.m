function [dVdt,dV_Glcdt,dV_Glndt,dXvdt,dXtdt,mu] = multiFeedGrowthStateFcnError(V,Xv,Xt,Metab,Q_Glc,Q_Gln)
%% parameters
Kdeath_Amm = 1.76;
K_Glc = 0.75;
K_Gln = 0.075;
Ki_Amm = 28.48*0.5;     % parameter error
Ki_Lac = 171.76*0.5;    % parameter error
n = 2;
mu_max = 0.058*0.9;     % parameter error
