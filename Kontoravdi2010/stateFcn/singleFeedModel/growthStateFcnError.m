function [dVdt,dXvdt,dXtdt,mu] = growthStateFcnError(V,Xv,Xt,Metab,Q_in)
%% parameters
Kdeath_Amm = 1.76;
K_Glc = 0.75;
K_Gln = 0.075;
Ki_Amm = 28.48*0.5; % P-M mismatch
Ki_Lac = 171.76*0.5; % P-M mismatch
n = 2;
mu_max = 0.058*0.9; % P-M mismatch 
