function [] = plotMultiFeed(Info_true,Info_error,simout,Ts,x0)
% for Kontoravdi2010 model

[t_true,X_true] = simTrueMFModel(Info_true,Ts,x0);
[t_error,X_error] = simTrueMFModel(Info_error,Ts,x0);
...
inputName = {'Glucose feed rate' 'Glutamine feed rate'};
